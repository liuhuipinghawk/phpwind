...
<div class="wrap">
    ...
    <div class="open-door cont">
        <div class="sluice">
            <ul class="clearfix">
                <li class="ajax-btn sluice-in1"><a href="javascript:void(0);" class="btn">B1闸机进口</a></li>
                <li class="ajax-btn sluice-out1"><a href="javascript:void(0);" class="btn">B1闸机出口</a></li>
                <li class="ajax-btn sluice-in2"><a href="javascript:void(0);" class="btn">B2闸机进口</a></li>
                <li class="ajax-btn sluice-out2"><a href="javascript:void(0);" class="btn">B2闸机出口</a></li>
