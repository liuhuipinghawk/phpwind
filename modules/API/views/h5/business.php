...
<div class="wrap">
    ...
    <div class="app-cont show-page">
        <div class="show-img text-center"  style="font-size: 0">
            <img src="/images/buss1.png" class="max-width" alt=""/>
            <img src="/images/buss2.png" class="max-width" alt=""/>
        </div>
    </div>
    <div class="footer border-top clearfix">
        <img src="/images/phone-buss.png" width="28" class="pull-left"><span class="pull-left phone phone-buss">400-6060-617</span>
        <a href="javascript:void(0);" class="pull-right book-btn btn-buss">立即预约</a>
    </div>
