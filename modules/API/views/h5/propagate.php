...
<div class="wrap">
    ...
    <div class="app-cont show-page">
        <div class="show-img text-center"  style="font-size: 0">
            <img src="/images/propagate1.png" class="max-width" alt=""/>
            <img src="/images/propagate2.png" class="max-width" alt=""/>
            <img src="/images/propagate3.png" class="max-width" alt=""/>
            <img src="/images/propagate4.png" class="max-width" alt=""/>
            <img src="/images/propagate5.png" class="max-width" alt=""/>
        </div>
    </div>
    <div class="footer border-top clearfix">
        <img src="/images/phone-plant.png" width="28" class="pull-left"><span class="pull-left phone phone-plant">13525567728</span>
...
<div class="book-tip box-content" style="display: none">
    <ul class="book-list">
        ...
        <li><p>预约成功后，工作人员会尽快与您确认需求或者拨打客服电话：<span class="text-orange">13525567728</span></p></li>
    </ul>
