    ...
    <table class="table table-striped table-bordered">
        ...
        <?php foreach ($catelist as $val){ ?>
            <tr>
                ...
                <td>&nbsp<a href="<?php echo \yii\helpers\Url::to(['category/view','id'=>$val['categoryId']]); ?>">查看</a>&nbsp;&nbsp;<a href="<?php echo \yii\helpers\Url::to(['category/update','id'=>$val['categoryId']]); ?>">更新</a>&nbsp;&nbsp;<a href="<?php echo \yii\helpers\Url::to(['category/delete','id'=>$val['categoryId']]) ?>">删除</a> </td>
            </tr>
        <?php  } ?>
    </table>
</div>
