...
<div>
	<h1><?=$this->title ?></h1>	
	<form class="form-inline" action="/admin/fushi/get-inout-record" onsubmit="return checkData();">
		<?php 
...
<script type="text/javascript">	
	...
	function jumpPage(page,total_page){
		...
		if (checkData()) {
			location.href = '/admin/fushi/get-inout-record?house_id='+$('#house_id').val()+'&stime='+$('#stime').val()+'&etime='+$('#etime').val()+'&page='+page;
		}
	}
</script>
