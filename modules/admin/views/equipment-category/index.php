...
/* @var $searchModel app\models\EquipmentCategorySearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = '办公设备分类列表';
$this->params['breadcrumbs'][] = $this->title;
?>
<div class="equipment-category-index" style="margin-left:210px">
    ...
    ?>
    <p>
        <?= Html::a('添加办公设备分类', ['create'], ['class' => 'btn btn-success']) ?>
    </p>
