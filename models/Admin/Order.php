...
class Order extends \yii\db\ActiveRecord
{
    ...
    {
        return [
            [['UserId', 'HouseId', 'SeatId', 'Status', 'maintenanceType', 'repair_id', 'deal_time', 'deal_user', 'start_time', 'complate_time', 'audit_time', 'comment_time', 'score', 'area_id', 'is_del'], 'integer'],
